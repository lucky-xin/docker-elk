...
## 生成的json数据详情
![生成的json数据详情](https://github.com/lucky-xin/docker-elk/blob/master/.img/index-json-detail.png)
## 生成的数据预览
![生成的数据预览](https://github.com/lucky-xin/docker-elk/blob/master/.img/data-preview.png)
